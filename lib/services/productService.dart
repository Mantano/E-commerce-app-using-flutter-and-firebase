...
class ProductService {
  ...
  Future<List> newItemArrivals() async {
    ...
    QuerySnapshot<Map<String, dynamic>> itemsRef = await _productReference
        .orderBy('name')
  ...
  Future<List> featuredItems() async {
    List<Map<String, String>> itemList = new List();
    QuerySnapshot<Map<String, dynamic>> itemsRef =
        await _productReference.limit(15).get();
  ...
  Future<List> listSubCategoryItems(String subCategoryId) async {
    ...
    QuerySnapshot<Map<String, dynamic>> productRef = await _productReference
  ...
  Future<List> listCategories() async {
    QuerySnapshot<Map<String, dynamic>> _categoryRef =
        await _categoryReference.get();
  ...
  Future<Map> particularItem(String productId) async {
    DocumentSnapshot<Map<String, dynamic>> prodRef =
        await _productReference.doc(productId).get();
